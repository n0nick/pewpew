...
namespace PewPew.Game
{
    ...
    class Target
    {
        ...
        { 
            { TargetName.Action1, new TargetType { inputText = "water,ice,wind", color = System.Windows.Media.Brushes.ForestGreen, fileName = "comb1.png" } },
            { TargetName.Action2, new TargetType { inputText = "stone,fire,magic", color = System.Windows.Media.Brushes.Yellow, fileName = "comb2.png"  } },
            { TargetName.Action3, new TargetType { inputText = "ice,wind,magic", color = System.Windows.Media.Brushes.Purple, fileName = "comb3.png"  } },
